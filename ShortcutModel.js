...
var DEFAULT = "SUPER + B"
var DESCRIPTION = "Post to Bluesky"
var COMMAND = "omarchy-shell shell toggle thenitai.bsky"
...
function registerCode(list, previous, next, owner) {
  ...
  return code + "_G.__bsky_shortcut_owner = " + JSON.stringify(owner)
}

function releaseCode(shortcut, owner) {
  return "if _G.__bsky_shortcut_owner == " + JSON.stringify(owner) + " then hl.unbind(" + JSON.stringify(shortcut) + "); _G.__bsky_shortcut_owner = nil end"
}
